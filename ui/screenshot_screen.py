...
class ScreenshotScreen:
    ...
    def render(
        ...
        draw_text(canvas, f"Status: {status_message}", (side_x + 20, side_y + 500), font_size=18, color=(230, 230, 230))
        y = side_y + 548
        ...
        draw_icon_dot(canvas, side_x + 28, side_y + side_h - 90, color=(0, 255, 255))
        draw_text(
            canvas,
    ...
    def _render_static_base(self, canvas, layout):
        ...
        draw_top_bar(
            ...
            subtitle="PEACE saves a screenshot. You can also press S.",
        )
        ...
        draw_text(canvas, "Guide", (side_x + 20, side_y + 150), font_size=28)

        lines = [
            "How to save a screenshot:",
            "",
            "1. Stand in front of the camera",
            "2. Make the PEACE gesture",
            "3. The app saves the image",
            "",
            "Alternative:",
            "- press S for a manual screenshot",
            "",
            "Detected hands:",
        ]
        draw_text_lines(
